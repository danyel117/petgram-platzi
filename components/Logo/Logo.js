...
function Logo(props) {
  return (
    <Link href='/'>
      ...
      >
        <defs>
          <filter id='prefix__editing-stripe-bk' filterUnits='userSpaceOnUse' x='-100%' y='-100%' width='300%' height='300%'>
            ...
            <feMorphology operator='dilate' radius={2} in='SourceAlpha' result='dilate' />
